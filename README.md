...
├──────────────────────────┼──────────────────────────────────────────────┤
│ 2. Encrypted DoH Tunnel  │ Clean queries are encrypted via HTTPS.       │
│                          │ Local ISPs (Jio, Airtel, ACT) cannot log.    │
├──────────────────────────┼──────────────────────────────────────────────┤
│ 3. Active AI Poisoning   │ Injects high-entropy synthetic personas into │
│                          │ the graph to destroy predictive confidence.  │
├──────────────────────────┼──────────────────────────────────────────────┤
│ 4. 100% Bank & OTP Safe  │ Zone A whitelist protects 60+ Indian & Global│
│                          │ banks, payment gateways, and tax portals.    │
└──────────────────────────┴──────────────────────────────────────────────┘
```
...
* **100% Client-Side:** No cloud servers, no user accounts, no telemetry collected.
* **$0.00 Cost:** Free forever, fully open-source under the MIT License.
* **Memory Footprint:** < 15MB RAM | CPU: < 0.05%.
